      ...
      <div className="d-flex" id="wrapper">
        ...
        <div className="bg-white" id="sidebar-wrapper">
          <div className="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">
            <a className="navbar-brand" href="https://www.hartleylab.com/">
              <img
                width="200"
                height="48"
                className="img-fluid opacity0"
                src="https://www.google.com/search?q=hartley+lab&sxsrf=AJOqlzVEVwS8RYaXSfE0_hO7SXjTrj4Yiw:1675777969423&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjS2tu0x4P9AhXZILcAHfeSA1UQ_AUoAnoECAEQBA&biw=1423&bih=670&dpr=0.96#imgrc=zSDb-aMYF3qjuM"
                alt="hartleylab"
              />
            </a>
          </div>
